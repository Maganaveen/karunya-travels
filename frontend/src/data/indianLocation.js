const indianLocations = [
  {
    ...
    type: 'State',
    districts: ['Anantapur','Chittoor','East Godavari','Guntur','Krishna','Kurnool','Nellore','Prakasam','Srikakulam','Visakhapatnam','Vizianagaram','West Godavari','YSR Kadapa','NTR','Alluri Sitharama Raju','Anakapalli','Bapatla','Eluru','Kakinada','Konaseema','Nandyal','Palnadu','Parvathipuram Manyam','Sri Sathya Sai','Tirupati']
  },
  {
  ...
  },
  {
    state: 'Sikkim',
    type: 'State',
    districts: ['East Sikkim','North Sikkim','South Sikkim','West Sikkim','Gangtok','Pakyong','Soreng','Gyalshing','Mangan','Namchi']
  },
  {
    state: 'Tamil Nadu',
    type: 'State',
